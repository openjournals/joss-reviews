...
- [ ] **Data sharing:** If the paper contains original data, data are accessible to the reviewers.
- [ ] **Data sharing:** If the paper contains original results, results are entirely reproducible by reviewers
